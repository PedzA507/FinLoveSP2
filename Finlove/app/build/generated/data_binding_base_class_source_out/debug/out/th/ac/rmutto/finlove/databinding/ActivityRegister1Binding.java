...
public final class ActivityRegister1Binding implements ViewBinding {
  ...
  private ActivityRegister1Binding(@NonNull ConstraintLayout rootView, @NonNull Button buttonNext,
      ...
      @NonNull TextView textView6, @NonNull TextView textViewPrivacyPolicy) {
  ...
  public static ActivityRegister1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegister1Binding((ConstraintLayout) rootView, buttonNext, editTextEmail,
          editTextPassword, editTextUsername, main, textView3, textView4, textView5, textView6,
